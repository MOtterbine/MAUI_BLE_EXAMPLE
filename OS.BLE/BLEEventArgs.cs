...
public delegate Task BLEEvent(object sender, BLEEventArgs e);

public class BLEEventArgs : EventArgs, IDisposable
{
    public BLEEventArgs(BLEEventTypes _evtType)
    {
        this.Event = _evtType;
    }

    public BLEEventTypes Event;
    public object data;
