...
public delegate void GattEvent(object sender, GattEventArgs e);

public enum GattEventTypes
{
    None,
    DataReady,
    ServicesDiscovered,
...
public class GattEventArgs : EventArgs, IDisposable
{

    public GattEventTypes EvenTypet;
    public object data;
    public string Description;
    public BluetoothGattCharacteristic characteristic = null; 

    public GattEventArgs(GattEventTypes _evtType = GattEventTypes.None)
    {
        this.EvenTypet = _evtType; 
    }
    #region IDisposable
